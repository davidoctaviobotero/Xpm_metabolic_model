...
$include "compounds-sort_ene24.txt"
/* or, include here your own file */

        j   Name of the reactions
$include "reactions_ene24.txt"
/* or, include here your own file */

        rev(j)  Reversible reactions (including exchange rxns)
$include "reversible_reactions_ene24.txt"
/* or, include here your own file */

        cytosol(i)      Cytosolic metabolites
$include "compounds-cyto_ene24.txt"
/* or, include here your own file */

        extracellular(i)  Extracellular metabolites
$include "compounds-extra_ene24.txt"
/* or, include here your own file */
;

PARAMETERS
  UB(j)     Upper bound on fluxes
$include "UpperBound_fluxes_ene24.txt"
/* or, include here your own file */

  LB(j)     Lower bound on fluxes
$include "LowerBound_fluxes_ene24.txt"
/* or, include here your own file */

  S(i,j)    Stoichiometric matrix
$include "S_matrix_corrected_ene24.txt"
/* or, include here your own file */
